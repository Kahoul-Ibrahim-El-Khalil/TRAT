...
int main(void) {
	...
	std::string update_url = fmt::format("{}{}/getUpdates?timeout=1&limit=1&offset=0", TELEGRAM_BOT_API_BASE_URL, TOKEN);

	std::string message_url = fmt::format("{}{}/sendMessage?chat_id={}&text=test", TELEGRAM_BOT_API_BASE_URL, TOKEN, MASTER_ID);
