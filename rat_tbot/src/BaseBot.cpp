...
BaseBot::BaseBot(const BaseBot &Other_Bot)
	: token(Other_Bot.token), master_id(Other_Bot.master_id), sending_message_url_base(Other_Bot.sending_message_url_base),
	  sending_document_url(Other_Bot.sending_document_url), sending_photo_url(Other_Bot.sending_photo_url),
	  sending_audio_url(Other_Bot.sending_audio_url), sending_video_url(Other_Bot.sending_video_url), sending_voice_url(Other_Bot.sending_voice_url),
