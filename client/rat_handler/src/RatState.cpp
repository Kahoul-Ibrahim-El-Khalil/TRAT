...
static constexpr const char *TOOLS[] = {
    "ffmpeg",   "curl", "wget",     "7z",         "zip",      "tar",
    "python",   "node", "git",      "powershell", "cmd",      "tasklist",
    "taskkill", "reg",  "schtasks", "netstat",    "ipconfig", "wmic",
    "msinfo32", "sc",   "ping",     "tracert",    "net",      "explorer",
    "notepad",  "calc", "mspaint"};
#else
static constexpr const char *TOOLS[] = {
    "ffmpeg",     "curl",    "wget", "7z",   "zip",      "tar", "python",
    "node",       "git",     "bash", "sh",   "ls",       "ps",  "kill",
    "top",        "htop",    "df",   "du",   "ifconfig", "ip",  "ping",
    "traceroute", "netstat", "ss",   "cron", "systemctl"};
#endif
