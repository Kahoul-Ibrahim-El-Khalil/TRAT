...
enum class BotResponse { SUCCESS, NO_FILE, CONNECTION_ERROR, NETWORK_ERROR, PARSE_ERROR, UNAUTHORIZED, UNKNOWN_ERROR };
...
struct Message {
	...
	Message() = default;
	Message(int64_t arg_Id, int64_t arg_Origin, const std::string &arg_Text) : id(arg_Id), origin(arg_Origin), text(arg_Text) {}
