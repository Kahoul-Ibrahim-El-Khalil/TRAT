...
/*This type is not supposed to own or manage the memory block it points to,
...
// data, it only refrence it;

// Compresses data in CompressionContext in-place (requires allocated buffer for
// compressed data)
bool zlibCompress(CompressionContext &Compression_Context);

// Decompresses data in CompressionContext in-place (requires allocated buffer
