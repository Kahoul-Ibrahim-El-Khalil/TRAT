...
class TelegramMessage
{
  public:
     ...
     */
    explicit TelegramMessage(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit TelegramMessage(const Json::Value &pJson) noexcept(false);
     ...
     */
    TelegramMessage(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<TelegramMessage>;
    friend drogon::orm::BaseBuilder<TelegramMessage, true, true>;
    friend drogon::orm::BaseBuilder<TelegramMessage, true, false>;
    friend drogon::orm::BaseBuilder<TelegramMessage, false, true>;
    friend drogon::orm::BaseBuilder<TelegramMessage, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<TelegramMessage>;
#endif
