...
#ifdef _WIN32
static constexpr const char *TOOLS[] = {"ffmpeg",	  "curl", "wget",	  "7z",		  "zip", "tar",		 "python",	"node",		"git",
										"powershell", "cmd",  "tasklist", "taskkill", "reg", "schtasks", "netstat", "ipconfig", "wmic",
										"msinfo32",	  "sc",	  "ping",	  "tracert",  "net", "explorer", "notepad", "calc",		"mspaint"};
#else
static constexpr const char *TOOLS[] = {"ffmpeg",	"curl", "wget", "7z",		  "zip",	 "tar", "python", "node",	  "git",
