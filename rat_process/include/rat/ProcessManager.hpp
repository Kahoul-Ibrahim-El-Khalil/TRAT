...
private:
    ...
    std::shared_ptr<::rat::threading::ThreadPool> p_output_handling_threadpool;
...
public:
    ...
    void setOutputHandlingThreadPool(std::shared_ptr<::rat::threading::ThreadPool>& p_Thread_Pool);
